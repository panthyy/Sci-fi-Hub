...
const BaseStyle = css`
  ${tw`px-4 w-fit py-5 rounded-md border-2 border-transparent shadow-md box-border font-inter font-semibold`}
  ${tw`hover:cursor-pointer  focus:outline-none active:scale-95`}
  ${tw`duration-200 ease-in-out transition`}
`;

const PrimaryStyle = css`
  ${tw`bg-[#4E7988] hover:bg-[#386473] active:bg-[#005066] text-white`}
`;
...
const StyledButton = styled.button((props: ButtonProps) => {
  ...
  return [
    ...
    outline &&
      primary &&
      tw`border-[#4E7988] text-[#4E7988] hover:bg-[#4E7988]`,
  ];
});
